...
type Department struct {
	Id              int       `json:"id" orm:pk,auto description:"id"`
	Name            string    `json:"name" orm:"column(Name)" description:"Name"`
	ParentId        int       `json:"parentid" orm:"column(Parentid)" description:"ParentId"`
	CreateDeptGroup bool      `json:"createdeptgroup" orm:"column(Createdeptgroup)" description:"CreateDeptGroup"`
	AutoAddUser     bool      `json:"autoadduser" orm:"column(Autoadduser)" description:"AutoAddUser"`
